    ...
    render() {
        ...
        return (
            <div>
                <div id="preloader">
                    <div id="status">
                        <img src={highkulpay} style={isMobile ? { left: "-3rem", top: "-2.7rem", width: "100px", marginTop: "10px", position: "absolute" } : { left: "-3rem", top: "-2.7rem", width: "138px", marginTop: "10px", position: "absolute" }} />
                            ...
                            <div className={isMobile ? "  container-fluid" : " cust-container3"}>
                               {!isMobile ? 
                                    ...
                                    <>
                                        ...
                                        <img src={highkulpaydark} style={{ width: "78px", marginTop: "-27px", float: 'right' }} />
                                ...
                                <div class="custom-form col-sm-10" style={!isMobile ? { marginTop: '10vh' } : { marginTop: '4vh' }}>
                                    <h2 style={!isMobile ? { fontSize: "36px", } : { fontSize: "28px", marginTop: '20px' }} className="outfit_head">
                                        Sign In
                                    </h2>
                                    <h2 style={!isMobile ? { fontSize: "14px", marginTop: '-13px', marginBottom: '18px', color: '#514f4f' } : { fontSize: "12px", color: '#514f4f', marginTop: '-15px' }} className="outfit_text">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="user" class="animated-label outfit_text" style={{ fontSize: "13px" }}>
                                            Email address
                                        </label>
                                    </div>
                                    <div className={!isMobile ? "form-group mt-5" : "form-group mt-4"}>
                                        ...
                                        <label for="pass" class="animated-label outfit_text" style={{ fontSize: "13px" }}>
                                            Password
                                        </label>
                                    </div>
                                    <div class="form-group">
                                        <div className="row">
                                            ...
                                            <div className="col-sm-12 col-lg-6">
                                                <button className="btn btn-primary outfit_text btn-mobile" type="button" onClick={this.handleSignIn} style={{ width: "164px", padding: "11px, 24px, 11px, 24px", fontSize: "14px", height: "48px" }}>
                                                    Sign In
                                                </button>
                                            </div>
                                            <div className="col-sm-12 col-lg-12 mt-4">
                                                <p className="outfit_text text-center" style={{ fontSize: "12px", color: "#1B52C4" }}>
