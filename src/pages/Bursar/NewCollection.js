                        ...
                        <div className="row" style={{ marginTop: "20px" }}>
                            <div className="col-sm-6">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="collection_name" className="form-control" placeholder="Enter collection name"/>
                                </div>
                            </div>
                            <div className="col-sm-6">
                                <div className="form-group">
                                    ...
                                    <br />
                                    {/* <small style={{color:'red'}}>Invoice number invalid <i className="fa fa-warning"/></small> */}
                                    <input type="number" className="form-control" placeholder="Enter collection amount" name="collection_amount"/>
                                </div>
                            </div>
                        </div>
