...
class MonthlyCollectionReport extends Component {
    state = {
    ...
    // curHour + ":" + curMinute + "." + curSeconds + curMeridiem + " " +
        ...
        const headerSecond = [
          ...
          const totalColumn = [[nairaFormat(this.state.amountSum, 2)]];
        let bodyFoot = [
          {
      ...
      // (<b>{d.vc}</b>)
        ...
        const schName = "KULPAY MERCHANT TRANSACTION REPORT";
...
//PORTRAIT ORIENTATION
        ...
        //doc.addImage(imgLogo, 'png', 50, 45, 50, 50);
          ...
          doc.setFontSize(12);
          doc.text("info@kulpay.com", (docWidth/3) + 50, 92)
          doc.setFontSize(30);
...
doc.setFont(undefined, 'normal')
    ...
    loadCollectionReportBy = () => {
        ...
        Endpoint.getMonthlyCollectionBy(this.state.payLoad?.institutionId)
                        .then((res) => {
                            //alert("1")
                    ...
                    this.setState({ loadSpinner: false });
                            ...
                            this.setState({collectionReportState: mappedData, amountSum: res.data?.totalAmount})
                            setTimeout(() => {
                                console.log(this.state.amountSum, "sum")
                            ...
                            <div className="row">
                                <div className="col-12 col-sm-12 col-xl-6 mt-2 mt-xl-0">
                                    <h1 className="manrope-text" style={!isMobile ? { fontSize: "33px", color: "#2E2C34" } : { fontSize: "24px", color: "#2E2C34" }}>
                                        ...
                                        Monthly Collection Report <span style={{ fontSize: "18px" }}>(February)</span>
                                    </h1>
...
{/* <Select defaultValue="Department" style={{ width: 200 }} onChange={this.handleChange}>
  ...
  <br/>
  <button className="btn btn-primary" onClick={this.loadCollectionReportBy}>Load Report</button> 
            </Space>
            <br/>
