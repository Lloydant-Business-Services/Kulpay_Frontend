...
doc.setFont(undefined, 'normal')
    ...
    doc.text('Page ' + String(i) + ' of ' + String(pageCount),docWidth-110, docHeight-40);
      ...
      onChangeDateFromAlt = (date, dateString) => {
        console.log(date, dateString);
        this.setState({dateFromAlt: dateString})
      }
      onChangeDateToAlt = (date, dateString) => {
        console.log(date, dateString);
        this.setState({dateToAlt: dateString})
      }
    ...
    loadCollectionReportBy = () => {
        ...
        Endpoint.getCollectionByDateRange(this.state.payLoad?.institutionId, this.state.dateFrom, this.state.dateTo)
                        .then((res) => {
                            //alert("1")
...
loadCollectionReportByAlt = () => {
    this.setState({ loadSpinner: true, filterPool:false });

    Endpoint.getCollectionByDateRange(this.state.payLoad?.institutionId, this.state.dateFromAlt, this.state.dateToAlt)
                    .then((res) => {
                        //alert("1")
                        console.log(res.data)
                this.setState({ loadSpinner: false });
                        ...
                        this.setState({collectionReportStateAlt: mappedData})
                    ...
                    <div className="container-fluid py-5 mt-3">
                        <>
                            <div className="row">
                                <div className="col-12 col-sm-12 col-xl-6 mt-2 mt-xl-0">
                                    <h1 className="manrope-text" style={!isMobile ? { fontSize: "33px", color: "#2E2C34" } : { fontSize: "24px", color: "#2E2C34" }}>
                                        ...
                                        Collection Comparison Report <span style={{ fontSize: "18px" }}>(By Date Range)</span>
                                    </h1>
                            ...
                            <Fade>
                                ...
                                <div className="col-6" style={{borderRight:"1px solid #80808075"}}>
...
{/* <div className="col-2">
                        ...
                        <div>
                                ...
                                <div id="dateFilterss">
            <Space direction="horizontal">
    <DatePicker onChange={this.onChangeDateFromAlt} />
    <DatePicker onChange={this.onChangeDateToAlt} />
  <button className="btn btn-primary" onClick={this.loadCollectionReportByAlt}>Load</button> 
    ...
    <Fade>
                                <Table
                                    ...
                                    // }}
                                    //dataSource={data}
                                    dataSource={this.state.collectionReportStateAlt}
