...
import { Table, Skeleton, Drawer, Select, DatePicker, Switch, Alert, Radio } from "antd";
import { currencyFormat, nairaFormat, nairaFormatAlt } from "../../../utils/helpers";
...
class InvoiceReport extends Component {
    ...
    loadAllCollectionByProgramme = (data) => {
        // getAllCollectionByPrimaryVendor
        Endpoint.getAllCollectionByProgramme(this.state.payLoad?.institutionId, data, parseInt(this.state.sessionSelect), parseInt(this.state.programmeSelect), false, this.state.dateFrom, this.state.dateTo)
            .then((res) => {
                //alert("1")
                console.log(res.data)
                this.setState({ loadSpinner: false });
                ...
                this.setState({
                    ...
                    totalAmountPaid: res?.data?.totalAmountPaidGeneric
                })
                this.processAmount(res.data?.totalAmount)
                this.processAmountAlt(res.data?.totalAmountPaid)
    ...
    loadAllCollectionByDepartment = (data) => {
        // getAllCollectionByPrimaryVendor
        Endpoint.getAllCollectionByDepartment(this.state.payLoad?.institutionId, data, parseInt(this.state.sessionSelect), parseInt(this.state.departmentSelect), false, this.state.dateFrom, this.state.dateTo)
            .then((res) => {
                //alert("1")
                console.log(res.data)
                this.setState({ loadSpinner: false });
    ...
    loadAllCollectionBySession = (data) => {
        // getAllCollectionByPrimaryVendor
        Endpoint.getAllCollectionBySession(this.state.payLoad?.institutionId, data, parseInt(this.state.sessionSelect), false, this.state.dateFrom, this.state.dateTo)
            .then((res) => {
                //alert("1")
                console.log(res.data)
                this.setState({ loadSpinner: false });
                ...
                this.setState({
                    ...
                    amountSum: nairaFormat(res.data?.totalAmount),
                    dynamicSum: nairaFormat(res.data?.totalAmount),
                    totalAmountPaidSum: res?.data?.totalAmountPaid
                })
                this.processAmount(res.data?.totalAmount)
                this.processAmountAlt(res.data?.totalAmountPaid)
            })
                            ...
                            <div className="row">
                                <div className="col-12 col-sm-12 col-xl-6 mt-2 mt-xl-0">
                                    <h1 className="manrope-text" style={!isMobile ? { fontSize: "33px", color: "#2E2C34" } : { fontSize: "24px", color: "#2E2C34" }}>
                                        ...
                                        Invoice Report <span style={{ fontSize: "18px" }}>(Collection)</span>
                                    </h1>
                                    <Alert style={{ width: '400px' }} showIcon icon={<i className="fa fa-info-circle"/>} type="success" message={<p className="manrope-text-light" style={{ fontSize: "10px" }}>
                                        This report presents all invoices generated based on your selection. It also indicates the total amount of invoice generated against the total number of invoices paid for
                                    </p>}/>
                                   
                                </div>
                                <div className="col-md-12" style={{marginTop:'-62px'}}>
                                ...
                                <div className="col-md-12" style={{marginTop:'-40px'}}>
                                    <span style={{ fontSize: "14px" }} className="">
                                        ...
                                        <div className="row" style={{ float: "right", marginTop:'20px' }}>
                                            ...
                                            <div className="col-sm-6">
                                                <div>
                                                    <span className="">Total Invoice Amount <small style={{ fontSize: "10px", marginTop: '5px', padding: "0px", background: "gold", fontWeight: "500" }}>NGN </small></span>
                                                    <TweenOne
                                                        animation={this.state.animation}
                                                        style={{ fontSize: 40, marginTop: 0, color: "#10804c", fontWeight: "600" }}
                                                    >
                                                        0.00 &nbsp;
                                                    </TweenOne>
                                                    {/* </div> */}
                                            ...
                                            <div className="col-sm-6">
                                                <div>
                                                    <span className="">Total Recept Amount <small style={{ fontSize: "10px", marginTop: '5px', padding: "0px", background: "gold", fontWeight: "500" }}>NGN </small></span>
                                                    <TweenOne
...
{/* <div className="row"> */}
                        ...
                        <Fade style={{ marginTop: "-50px" }}>
                            ...
                            <div>
                                ...
                                <Radio.Group value={this.state.inflowSelectValue} defaultValue="collection" className="manrope-text" onChange={(e) => this.setInflowType(e.target.value)}>
                                    {/* <Radio.Button style={{ fontSize: "15px" }} value="collection">Collection</Radio.Button>
                                    <Radio.Button style={{ fontSize: "15px" }} value="bank">Bank</Radio.Button> */}
