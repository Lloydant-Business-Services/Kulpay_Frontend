    ...
    addDepartments = () => {
        ...
        .then((res) => {
            console.log(res.data)
                ...
                this.initiateUpdateOnboardStatus(this.state.payLoad.personId, boardingStatus.Vendor)
                this.loadDataFromServer();
        })
        .catch((error) => {
            console.log(error)
...
initiateUpdateOnboardStatus = (personId, status) => {
    ...
    .then((res) => {
        ...
        updateBordingLocal(boardingStatus.Vendor)
    })
    .catch((err) => {
        console.log(err)
    })
                                    ...
                                    <div className="row cmt-2">
                                        <div className="col-sm-12">
                                            <p className="manrope-text-light" style={{ fontSize: "13px" }}>
                                                ...
                                                Select one or more faculties/schools as applicaple to your institution from the pool presented below
                                            </p>
                                        </div>
                                    </div>
